            ...
            <table class="table table-hover">
                ...
                @forelse($messages as $message)
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="{{ route('dashboard.contacts.show', $message->id) }}" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                                ...
                                <form action="{{ route('dashboard.contacts.destroy', $message->id) }}" method="post" id="message-delete-{{ $message->id }}" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </div>
