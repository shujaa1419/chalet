...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary">Create chalet</h6>
            <div class="ml-auto">
        ...
        <div class="card-body">
            ...
            {!! Form::open(['route' => 'dashboard.chalets.store', 'method' => 'post', 'files' => true]) !!}
            <div class="row">
                <div class="col-12">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    {!! Form::select('city_id', ['' => '---'] + $cities->toArray(), old('city_id'), ['class' => 'form-control']) !!}
            ...
            <div class="row pt-4">
                <div class="col-12">
                    ...
                    <div class="file-loading">
                        {!! Form::file('images[]', ['id' => 'chalet-images', 'class' => 'file-input-overview', 'multiple' => 'multiple']) !!}
