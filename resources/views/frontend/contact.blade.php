            ...
            <div class="row">
                <div class="col-lg-8 col-12">
                    <div class="contact-form-wrap">
                        <h2 class="contact__title">{{__('frontend.Get in touch')}}</h2>
                        <p></p>
                        <form id="contact-form" action="{{route('chalet.frontend.do_contact')}}" method="post">
                            @csrf
                            ...
                            <div class="contact-btn">
                                <button type="submit">{{__('frontend.Send Message')}}</button>
                            </div>
                        </form>
                    </div>
                </div>
